...
class Application
{
    ...
    public function __construct()
    {
        ...
        // If contrller is null / show Login page
        ...
        elseif (file_exists('./application/controller/' . $this->url_controller . '.php')) {            
            ...
            define('PAGE', $this->url_action ); // Save the name of the page
            ...
            if (method_exists($this->url_controller, $this->url_action)) {
                ...
                $this->url_controller->index($con="");
            }
        }  else {
            // invalid URL, so simply show home/index
            echo "<center><h2> :( Sorry, the page you are looking for does not exists<br>
                    <a href='". URL ."'>click here lets take you home</a>
                   </h2></center>" ;
        }
    }
